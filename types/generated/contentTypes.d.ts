...
export interface ApiAchievementAchievement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    athlete: Schema.Attribute.Relation<'manyToOne', 'api::athlete.athlete'>;
...
export interface ApiAthleteAthlete extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email & Schema.Attribute.DefaultTo<'no@email.com'>;
    ...
    nationality: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'congolaise'>;
    nom: Schema.Attribute.String;
    phone: Schema.Attribute.String;
    photo: Schema.Attribute.Text;
    postNom: Schema.Attribute.String;
...
export interface ApiCoachCoach extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    athletes: Schema.Attribute.Relation<'oneToMany', 'api::athlete.athlete'>;
    birthday: Schema.Attribute.Date;
    competitions: Schema.Attribute.Relation<
      'manyToMany',
      'api::competition.competition'
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::coach.coach'> &
      Schema.Attribute.Private;
    matricule: Schema.Attribute.String & Schema.Attribute.Unique;
    nationality: Schema.Attribute.String;
    nom: Schema.Attribute.String;
...
export interface ApiCompetitionCompetition extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    achievements: Schema.Attribute.Relation<
      ...
      'api::achievement.achievement'
    >;
    athletes: Schema.Attribute.Relation<'manyToMany', 'api::athlete.athlete'>;
    ...
    >;
    journalists: Schema.Attribute.Relation<
      'manyToMany',
    ...
    > &
      Schema.Attribute.Private;
    medical_staffs: Schema.Attribute.Relation<
      'manyToMany',
      'api::medical-staff.medical-staff'
    >;
    name: Schema.Attribute.String;
    officials: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiFederationFederation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    officials: Schema.Attribute.Relation<'oneToMany', 'api::official.official'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiJournalistJournalist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    matricule: Schema.Attribute.String & Schema.Attribute.Required;
    mediaOutlet: Schema.Attribute.String;
    nom: Schema.Attribute.String;
    phone: Schema.Attribute.String;
    postNom: Schema.Attribute.String;
    prenom: Schema.Attribute.String;
...
export interface ApiOfficialOfficial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.String & Schema.Attribute.DefaultTo<'no@email.com'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::medical-staff.medical-staff': ApiMedicalStaffMedicalStaff;
